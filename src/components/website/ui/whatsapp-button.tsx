    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-full right-0 mb-4 px-4 py-2 bg-white text-[#25D366] text-sm font-[800] rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.15)] border border-slate-100 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0 pointer-events-none whitespace-nowrap flex items-center gap-2">
                <span className="text-[#323232]">Dubbi?</span> Scrivici su WhatsApp
                <div className="absolute -bottom-1 right-6 w-3 h-3 bg-white rotate-45 border-r border-b border-slate-100"></div>
            </div>
            ...
            {/* Main Button */}
            <div className="relative flex items-center justify-center w-14 h-14 md:w-16 md:h-16 bg-[#25D366] text-white rounded-full shadow-lg shadow-[#25D366]/40 hover:shadow-[#25D366]/60 hover:scale-110 active:scale-95 transition-all duration-300">
                <svg
                    viewBox="0 0 24 24"
