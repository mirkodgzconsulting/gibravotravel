            ...
            {filteredTours.map((tour) => (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  {/* Archivos y Copiar - Todos al mismo nivel */}
                    ...
                    <button
                      ...
                      className={`p-2.5 rounded-xl transition-all duration-200 shadow-sm hover:shadow-md ${
                        copiedTours.has(tour.id)
                          ...
                          : 'bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/30 dark:to-green-800/20 text-green-600 dark:text-green-400 hover:from-green-100 hover:to-green-200 dark:hover:from-green-800/40 dark:hover:to-green-900/30'
                      }`}
